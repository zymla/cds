...
ports
```
You need to have the `starefossen/pgrouting:latest` docker image available. If you haven't done so already, you need to run in your shell `docker pull starefossen/pgrouting:latest`  beforehand.
```{r}
