                                      ...
                                      column(width = 3, 
                                        box(title = "Paramètres d'entrée", status = "primary", solidHeader = TRUE, collapsible = TRUE, width = NULL, 
                                          ...
                                          checkboxGroupInput("Jours", label = "Jours",
                                            ...
                                            sliderInput("Choix_heure", label = "Plage horaire",                        min = 0, max = 24,  value = c(16, 20),  width = "100%"),
                                            sliderInput("Nb_tr_min",   label = "Nombre minimum de trajets par heure",  min = 0, max = 0.2, value = 0, step = 0.05,  width = "100%"),
